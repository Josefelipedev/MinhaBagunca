# import re
#
# def remover_carater(cnpj): #posso usar replace também mas tem mais linhas de codigo
#     return re.sub(r'[^0-9]', '', cnpj)
#
#
# def numero_pass(index):
...
#     return print(index)
#
# def valida_cnpj(novo_cnpj,index):
#     for index in range(19):
#         if index > 5:
#             index -= 8
#     total = 0
...
#     return total
#
# def contagem_reversa(index):
#     if index > 5:
#         index -= 8
#     contagem_reversa = index
#     return contagem_reversa
