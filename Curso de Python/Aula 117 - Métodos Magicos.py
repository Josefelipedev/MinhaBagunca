...
"""O init e executado de cara ,pode se chama de construtor
mas tem outro que o __new__ , que iniciar primeiro.
Com o new voce pode criar atributo de class e chama-lo.
Estuda todos os metedos que está no link a cima.
